 ...
 * Declare programs 
 **/
extern FACTORYIO_DEMO RES0__INSTANCE0;
...
{&(RES0__INSTANCE0.MAIN_CONVEYOR), BOOL_ENUM},
{&(RES0__INSTANCE0.SCALE_CONVEYOR), BOOL_ENUM},
{&(RES0__INSTANCE0.SEND_FORWARD), BOOL_ENUM},
{&(RES0__INSTANCE0.SEND_LEFT), BOOL_ENUM},
{&(RES0__INSTANCE0.SEND_RIGHT), BOOL_ENUM},
{&(RES0__INSTANCE0.FRONT_CONVEYOR1), BOOL_ENUM},
{&(RES0__INSTANCE0.FRONT_CONVEYOR2), BOOL_ENUM},
{&(RES0__INSTANCE0.RIGHT_CONVEYOR1), BOOL_ENUM},
{&(RES0__INSTANCE0.RIGHT_CONVEYOR2), BOOL_ENUM},
{&(RES0__INSTANCE0.LEFT_CONVEYOR1), BOOL_ENUM},
{&(RES0__INSTANCE0.LEFT_CONVEYOR2), BOOL_ENUM},
{&(RES0__INSTANCE0.LEFT_ROLLER1), BOOL_ENUM},
{&(RES0__INSTANCE0.LEFT_ROLLER2), BOOL_ENUM},
{&(RES0__INSTANCE0.RIGHT_ROLLER1), BOOL_ENUM},
{&(RES0__INSTANCE0.RIGHT_ROLLER2), BOOL_ENUM},
{&(RES0__INSTANCE0.HEAVY_INDICATOR), BOOL_ENUM},
{&(RES0__INSTANCE0.LIGHT_INDICATOR), BOOL_ENUM},
{&(RES0__INSTANCE0.SCALE_SENSOR), BOOL_ENUM},
{&(RES0__INSTANCE0.SCALE_TIMEOUT), BOOL_ENUM},
{&(RES0__INSTANCE0.WAIT_TIME), INT_ENUM},
{&(RES0__INSTANCE0.WEIGHT), INT_ENUM},
...
{&(RES0__INSTANCE0.LEFT_STICK_SENSOR), BOOL_ENUM},
{&(RES0__INSTANCE0.RIGHT_STICK_SENSOR), BOOL_ENUM},
{&(RES0__INSTANCE0.LEFT_STICK_DOWN), BOOL_ENUM},
{&(RES0__INSTANCE0.LEFT_STICK_GRAB), BOOL_ENUM},
{&(RES0__INSTANCE0.LEFT_STICK_LEFT_ROTATION), BOOL_ENUM},
{&(RES0__INSTANCE0.LEFT_STICK_RIGHT_ROTATION), BOOL_ENUM},
{&(RES0__INSTANCE0.LEFT_STICK_ENDEND), BOOL_ENUM},
{&(RES0__INSTANCE0.RIGHT_STICK_DOWN), BOOL_ENUM},
{&(RES0__INSTANCE0.RIGHT_STICK_GRAB), BOOL_ENUM},
{&(RES0__INSTANCE0.RIGHT_STICK_LEFT_ROTATION), BOOL_ENUM},
{&(RES0__INSTANCE0.RIGHT_STICK_RIGHT_ROTATION), BOOL_ENUM},
{&(RES0__INSTANCE0.RIGHT_STICK_EXTEND), BOOL_ENUM},
...
{&(RES0__INSTANCE0.RIGHT_GODOWN1), BOOL_ENUM},
{&(RES0__INSTANCE0.RIGHT_GODOWN2), BOOL_ENUM},
{&(RES0__INSTANCE0.LEFT_GODOWN1), BOOL_ENUM},
{&(RES0__INSTANCE0.LEFT_GODOWN2), BOOL_ENUM},
{&(RES0__INSTANCE0.START_RIGHT_ROLLER1), BOOL_ENUM},
{&(RES0__INSTANCE0.START_LEFT_ROLLER1), BOOL_ENUM},
...
{&(RES0__INSTANCE0.TOF7.EN), BOOL_ENUM},
{&(RES0__INSTANCE0.TOF7.ENO), BOOL_ENUM},
{&(RES0__INSTANCE0.TOF7.IN), BOOL_ENUM},
{&(RES0__INSTANCE0.TOF7.PT), TIME_ENUM},
{&(RES0__INSTANCE0.TOF7.Q), BOOL_ENUM},
{&(RES0__INSTANCE0.TOF7.ET), TIME_ENUM},
{&(RES0__INSTANCE0.TOF7.STATE), SINT_ENUM},
{&(RES0__INSTANCE0.TOF7.PREV_IN), BOOL_ENUM},
{&(RES0__INSTANCE0.TOF7.CURRENT_TIME), TIME_ENUM},
{&(RES0__INSTANCE0.TOF7.START_TIME), TIME_ENUM},
{&(RES0__INSTANCE0._TMP_GE18_OUT), BOOL_ENUM},
{&(RES0__INSTANCE0._TMP_LE16_OUT), BOOL_ENUM},
